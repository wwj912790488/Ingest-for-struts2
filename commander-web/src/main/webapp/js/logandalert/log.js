function Log(category) {
	...
	function showDeleteConfirmDialog() {
		try{
			var dialog = new window.top.TemplateDialog($("#dialog_delete"));
	...
	function showAlertConfigDialog(){
		...
		top.$.get('loadAlertSetting', function(data){
			var height = 264;
			if(data != null){
	...
	function saveAlertSetting(dialog){
		...
		$.post('saveAlertSetting', p, function(data){
