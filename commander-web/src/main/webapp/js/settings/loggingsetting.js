...
LoggingSetting.prototype.init = function() {
	...
	// bind update button
	$("#btnUpdateLogging").click(LoggingSetting.prototype.update);
};

LoggingSetting.prototype.update = function() {
