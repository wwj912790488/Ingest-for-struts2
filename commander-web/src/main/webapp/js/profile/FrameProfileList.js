...
function TTL_Edit(){
	...
	location.href="FrameeditProfile?profileId=" + sel[0]+"&fromUri=FramelistProfile";
}
...
function TTL_Copy(){
	...
	location.href="FramenewProfile?profileId=" + sel[0]+"&fromUri=FramelistProfile";
}
...
function TTL_Del(){
	...
	window.location.href='FramedeleteProfile?liveProfileId=' + sel[0];
}
...
function TTL_ImportProfiles() {
	if(g_ImportDialog == null) {
		...
		g_ImportDialog.Init("FrameimportProfiles", body);
