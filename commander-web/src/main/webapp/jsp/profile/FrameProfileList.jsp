...
jspContext.addJSRef("js/profile/FrameProfileList.js");
...
<script type="text/javascript">
	...
	function doFilter(f){
		window.location.href='FramelistProfile?filter=' + f;
	}
				...
				<tr>
					...
					<td style="width: 100px">
						<div class="action_btns">
							<a onclick="window.location.href='FramenewProfile.action?fromUri=FramelistProfile'">
								<span class="btn_left"></span>
