<div class="cm_operatebar" style="background: transparent;background-color: #fafafa;vertical-align: bottom;">
	<div class="left">
		<form method="post" action="frameList${actionModule}.action" id="logForm">
...
<div class="cm_actionbar">
	...
	<div id="sss" class="item img_export" style="display:none;float: right;margin-right: 20px;"><s:text name="alert.config.setting"/></div>
	</s:if>
</div>
