...
jspContext.addJSRef("js/popup_layer.js");
jspContext.addJSRef("js/common/util.js");
jspContext.addJSRef("js/framecommon.js");
jspContext.addJSRef("js/record/framelistrecord.js");
...
<div id="record_content">
	<div class="list_view_header" style="background: transparent;background-color: #fafafa;">
		<div class="cm_operatebar" style="background: transparent;vertical-align: bottom;">
			<div class="left">
				<form id="queryForm" action="frameListRecord.action">
			...
			<div class="right">
				<div class="action_normal_btns">
					<a id="btnQuery">
						...
						<span class="cntv_btn_middle"><p><s:text name="common.action.query"/></p></span>
		...
		<div class="cm_actionbar">
			...
			<%--<div id="btnSetting" class="item img_export" style="float: right;margin-right: 20px;"><s:text name="record.task.setting"/></div>--%>
		</div>
		<table class="tab_list">
			<thead>
				<tr class="tab_header">
					...
					<th style="width:200px"><s:text name="channel.name"/>(<s:text name="channel.program_name"/>)</th>
					<th style="width:120px"><s:text name="record.task.type"/></th>
					<th style="width:300px"><s:text name="record.task.run.time"/></th>
		...
		<table class="tab_list single_selection">
			<tfoot>
				<tr class="tab_header">
					...
					<td style="width:200px"><s:text name="channel.name"/>(<s:text name="channel.program_name"/>)</td>
					<td style="width:120px"><s:text name="record.task.type"/></td>
					<td style="width:300px"><s:text name="record.task.run.time"/></td>
					<td><s:text name="record.task.file.path"/></td>
				</tr>
			</tfoot>
			<tbody>
				<s:iterator value="pager.result" var="rs">
					<tr class="tab_content" style="line-height: 23px">
						<td style="width:30px; text-align: center"><input type="checkbox" name="id" value="${rs.id}"/><span style="display: none" class="tag_recordtype">${rs.recordType}</span></td>
						<td style="width:50px">${rs.id}</td>
						<td style="width:200px">
							<div class="app_text_ellipsis" style="width: 200px"><s:property value="%{getChannelName(#rs.channelId)}"/></div>
							<s:if test="#rs.name != null"><div class="app_text_ellipsis" style="width: 200px">(${rs.name})</div></s:if>
						</td>
