	...
	<table style="width: 100%" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td>
				...
				<s:iterator value="groupView.groupList" var="group">
				<table class="tab_content" id="tab_content_${group.name}" style="display: hidden; width: 100%">
				...
				<tr class="epg_record_line" style="border-bottom: 1px dotted gray">
					...
					<td width="80px">
						<s:date name="#epgItem.schedule.startTime" format="HH:mm:ss" />
					</td>
					<td>
						<s:date name="#epgItem.schedule.endTime" format="HH:mm:ss" />
					</td>
				</tr>
				</s:iterator>
				</table>
