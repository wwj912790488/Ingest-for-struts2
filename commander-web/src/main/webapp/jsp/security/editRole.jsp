<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="dialog_edit_role" style="display: none">
	<div class="template_title">
	<s:text name="security.role.edit" />
	</div>
	<div class="template_content" parent_align="center">
		<div class="top_mov_20">
		<form id="update_role_form" method="post" action="updateRole.action" onsubmit="return false">
			<table width="100%">
				<tr>
