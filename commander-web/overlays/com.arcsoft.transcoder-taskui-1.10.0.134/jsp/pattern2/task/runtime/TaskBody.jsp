...
<div class="Task" style="background-color: #fff">
	...
	<table>
		<tr>
			...
			<td>
				<s:include value="/jsp/pattern2/task/runtime/TaskBaseInfo.jsp"/>
				<s:include value="/jsp/pattern2/template/input/runtime/InputSetting.jsp"/>
				<s:include value="/jsp/pattern2/template/output/runtime/StreamSetting.jsp"/>
				<s:include value="/jsp/pattern2/template/output/runtime/OutputSetting.jsp"/>
			</td>
			<td class="BodyIndent"><div class="LinePlaceHolder"></div></td>
		</tr>
	</table>
