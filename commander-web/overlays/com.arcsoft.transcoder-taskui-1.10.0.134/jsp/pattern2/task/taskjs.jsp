...
jspContext.addJSRef("js/pattern2/template/output/Stream.js");
...
jspContext.addJSRef("js/pattern2/task/Task.js");
jspContext.addJSRef("js/pattern2/template/output/StreamTab.js");
