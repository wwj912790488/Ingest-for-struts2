...
<div id="AudioPCM" class="AudioDetail">
	...
	<div class="param">
		<span class="TaskLabelText lbl"><s:text name="audio.bits_per_sample"/>:</span>
		<span class="val"><s:property value="#audioDescription.audioSetting.bitsPerSample==0x10000000?getText('video.followSource'):#audioDescription.audioSetting.bitsPerSample"/></span>
	</div>
	<div class="param">
