...
<div id="VideoMpeg1" class="VideoDetail">
	<div class="param">
	...
	<div class="param">
		...
		<span class="val"><s:property value="#liveOutput.streamAssembly.videoDescription.width"/>
		x
		<s:property value="#liveOutput.streamAssembly.videoDescription.height"/></span>
	</div>
	<div class="param">
	...
	<div class="param">
		...
		<span class="val"><s:property value="#liveOutput.streamAssembly.videoDescription.videoSetting.bufSize"/></span>
	</div>
	<div class="param">
		<span class="TaskLabelText lbl"><s:text name="video.initialBufferFill"/>:</span>
		<span class="val"><s:property value="#liveOutput.streamAssembly.videoDescription.videoSetting.bufFillPct"/>
		<s:text name="common.millisecond"/></span>
	</div>
	<div class="param">
