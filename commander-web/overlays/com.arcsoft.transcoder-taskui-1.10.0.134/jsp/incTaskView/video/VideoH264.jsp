...
<div id="VideoH264" class="ParamTableBody">
	...
	<div class="param">
		...
		<span class="val"><s:text name="%{'H264CodecLevel.' + #liveOutput.streamAssembly.videoDescription.videoSetting.codecLevelId}"/></span>
	</div>
	<div class="param">
		<span class="TaskLabelText lbl"><s:text name="video.resolution"/>:</span>
		<span class="val">
			<s:property value="#liveOutput.streamAssembly.videoDescription.width"/>x<s:property value="#liveOutput.streamAssembly.videoDescription.height"/>
		</span>
	</div>
	<div class="param">
	...
	<div class="param">
		...
		<span class="val"><s:property value="#liveOutput.streamAssembly.videoDescription.videoSetting.bufFillPct"/>ms</span>
	</div>
