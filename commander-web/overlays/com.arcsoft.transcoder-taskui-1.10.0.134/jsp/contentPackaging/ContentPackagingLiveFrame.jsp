...
jspContext.addJSRef("js/contentPackaging/ContentPackagingLive.js");
jspContext.addJSRef("js/contentPackaging/DynamicTextEditor.js");
jspContext.addJSRef("js/contentPackaging/ContentPackagingDef.js");
jspContext.addJSRef("js/contentPackaging/ContentPackagingList.js");
...
<body onload="OnContentPackagingLoad()">
	<div class="ContentPackagePos">
		<s:include value="/jsp/contentPackaging/ContentPackagingLive.jsp"/>
	</div>
	...
	<div id="TemplateLib" style="display: none">
		...
		<s:include value="/jsp/contentPackaging/ContentPackagingListItem.jsp"/>
		<s:include value="/jsp/contentPackaging/DynamicTextEditor.jsp"/>
	</div>
</body>
</html>
