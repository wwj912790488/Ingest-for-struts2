		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="VideoCodec" class="TaskContentText VideoSelect">
					<option value="MPEG1" selected="selected">MPEG1</option>
				</select>
				<input type="hidden" name="VideoSetting" value="MPEG1"/>
				<span class="VideoCodecText TaskContentText Hide">MPEG1</span>
			</td>
