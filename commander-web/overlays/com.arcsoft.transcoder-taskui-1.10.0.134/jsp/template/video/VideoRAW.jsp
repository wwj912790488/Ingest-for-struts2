...
<div id="VideoRAW" class="VideoDetail">
	...
	<table>
		<tr>
			...
			<td class="VideoColumn2">
				...
				<input type="hidden" name="VideoSetting" value="RAW"/>
				<span class="VideoCodecText TaskContentText Hide">RAW</span>
			</td>
	...
	<table class="Hide">
		<tr>
			...
			<td class="VideoColumn2">
				...
				<span class="TaskContentText"><s:text name="video.frames"/></span>
			</td>
			<td><div class="LinePlaceHolder"></div></td>
		</tr>
	</table>
		...
		<tr>
			...
			<td class="VideoColumn2 Hide">
				<select name="VideoCodecProfile" class="TaskContentText VideoSelect">
					<option value="RAW_Profile" selected="selected"></option>
				</select>
			</td>
