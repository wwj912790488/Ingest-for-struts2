...
<s:set var="videoType" value="'H263'"/>
<div id="VideoH263" class="VideoDetail">
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="VideoCodec" class="TaskContentText VideoSelect">
					<option value="H263" selected="selected">H263</option>
				</select>
				<input type="hidden" name="VideoSetting" value="H263"/>
			</td>
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="VideoCodecProfile" class="TaskContentText VideoSelect">
					<option value="Profile5" selected="selected"></option>
				</select>
			</td>
			<td class="VideoColumn1 LabelAlign LicenseH263Level">
				<span class="TaskLabelText"><s:text name="video.level"/>:</span>
			</td>
			<td class="LabelEndSpacing LicenseH263Level"><div class="LinePlaceHolder"></div></td>
			<td class="VideoColumn2 LicenseH263Level">
	...
	<table class="LicenseVideoGopType">
		<tr>
			...
			<td class="LabelEndSpacing"><div class="LinePlaceHolder"></div></td>
			<td class="VideoColumn2">
				<select name="VideoGopType LicenseVideoGopType" class="TaskContentText VideoSelect">
