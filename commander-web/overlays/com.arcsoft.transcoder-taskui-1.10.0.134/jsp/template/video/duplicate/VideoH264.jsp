...
<s:set var="videoType" value="'H264'"/>
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="VideoCodecProfile" class="TaskContentText VideoSelect">
					<option value="High" selected="selected"></option>
				</select>
			</td>
			<td class="VideoColumn1 LabelAlign">
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="VideoSCD" class="TaskContentText VideoSelect">
					<option value="<s:property value="[0].getVideoDescription(#videoType).videoSetting.scd"/>" selected="selected"></option>
				</select>
			</td>
			<td><div class="LinePlaceHolder"></div></td>
		</tr>
