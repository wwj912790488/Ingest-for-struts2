...
<div id="VideoDV" class="VideoDetail">
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="VideoCodec" class="TaskContentText VideoSelect">
					<option value="DV" selected="selected">DV</option>
				</select>
				<input type="hidden" name="VideoSetting" value="DV"/>
			</td>
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="VideoCodecProfile" class="SummaryTrigger TaskContentText VideoSelect">
					<option value="DV25411" selected="selected"></option>
				</select>
			</td>
	...
	<div class="LineSpacing"></div>
	<!--3  -->
	<!-- gop size is used to skip validator -->
