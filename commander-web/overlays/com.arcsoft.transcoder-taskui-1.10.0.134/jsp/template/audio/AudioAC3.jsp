...
<div id="AudioAC3" class="AudioDetail">
	<!-- line1 -->
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="AudioCodec" class="SummaryTrigger TaskContentText AudioSelect">
					<option value="AC3" selected="selected">AC3</option>
				</select>
				<input type="hidden" name="AudioSetting" value="AC3"/>
				<span class="AudioCodecText TaskContentText Hide">AC3</span>
			</td>
