...
<div id="AudioMP2" class="AudioDetail">
	<!-- line1 -->
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="AudioCodec" class="SummaryTrigger TaskContentText AudioSelect">
					<option value="MP2" selected="selected">MP2</option>
				</select>
				<input type="hidden" name="AudioSetting" value="MP2"/>
				<span class="AudioCodecText TaskContentText Hide">MP2</span>
			</td>
