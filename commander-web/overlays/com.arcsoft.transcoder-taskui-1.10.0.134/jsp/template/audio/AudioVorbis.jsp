...
<div id="AudioVorbis" class="AudioDetail">
	<!-- line1 -->
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="AudioCodec" class="SummaryTrigger TaskContentText AudioSelect">
					<option value="Vorbis" selected="selected">Vorbis</option>
				</select>
				<input type="hidden" name="AudioSetting" value="Vorbis"/>
				<span class="AudioCodecText TaskContentText Hide">Vorbis</span>
			</td>
