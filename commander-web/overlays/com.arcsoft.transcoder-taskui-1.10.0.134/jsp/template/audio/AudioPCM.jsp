...
<div id="AudioPCM" class="AudioDetail">
	<!-- line1 -->
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="AudioCodec" class="SummaryTrigger TaskContentText AudioSelect">
					<option value="PCM" selected="selected">PCM</option>
				</select>
				<input type="hidden" name="AudioSetting" value="PCM"/>
				<span class="AudioCodecText TaskContentText Hide">PCM</span>
			</td>
			...
			<td class="VideoColumn2 Hide">
				<select name="AudioCodecProfile" class="SummaryTrigger TaskContentText AudioSelect">
					<option value="profilePCM">profilePCM</option>
				</select>
			</td>
	...
	<table>
		<tr>
			...
			<td class="VideoColumn1 LabelAlign">
				<span class="TaskLabelText"><s:text name="audio.bits_per_sample"/>:</span>
			</td>
			<td class="LabelEndSpacing"><div class="LinePlaceHolder"></div></td>
			<td class="VideoColumn2">
				<select name="AudioBitsPerSample" class="TaskContentText AudioSelect">
					<option value="<s:property value="[0].audioSetting.bitsPerSample"/>" selected="selected"></option>
				</select>
			</td>
			<td class="VideoColumn1 LabelAlign">
