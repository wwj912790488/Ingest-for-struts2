...
<div id="AudioDTS" class="AudioDetail">
	<!-- line1 -->
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="AudioCodec" class="SummaryTrigger TaskContentText AudioSelect">
					<option value="DTS" selected="selected">DTS</option>
				</select>
				<input type="hidden" name="AudioSetting" value="DTS"/>
				<span class="AudioCodecText TaskContentText Hide">DTS</span>
			</td>			
	...
	<table>
		<tr>
			...
			<td class="LabelEndSpacing"><div class="LinePlaceHolder"></div></td>
			<td class="">
				<span class="TaskCommentText"><s:text name="audio.dts.bitrate.info"/></span>
			</td>
			<td><div class="LinePlaceHolder"></div></td>
		</tr>
	</table>
	...
	<table>
		<tr>			
			...
			<td class="VideoColumn1 LabelAlign">
				<span class="TaskLabelText"><s:text name="audio.encoding.mode"/>:</span>
			</td>
			<td class="LabelEndSpacing"><div class="LinePlaceHolder"></div></td>
			<td class="VideoColumn2">
				<select name="AudioEncodingMode" class="SummaryTrigger TaskContentText AudioSelect">
					<option value="<s:property value="[0].audioSetting.encodingMode" />" selected="selected"></option>
				</select>				
			</td>
			<td><div class="LinePlaceHolder"></div></td>
		</tr>
