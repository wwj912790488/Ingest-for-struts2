...
<div id="AudioWMA" class="AudioDetail">
	<!-- line0 -->
		...
		<tr>
			...
			<td class="VideoColumn2">
				<select name="AudioCodec" class="SummaryTrigger TaskContentText AudioSelect">
					<option value="WMA" selected="selected"></option>
				</select>
				<input type="hidden" name="AudioSetting" value="WMA"/>
				<span class="AudioCodecText TaskContentText Hide">WMA</span>
			</td>
