...
<div id="AudioAAC" class="AudioDetail">
	...
	<table>
		<tr>
			...
			<td class="VideoColumn2">
				...
				<input type="hidden" name="AudioSetting" value="AAC"/>
				<span class="AudioCodecText TaskContentText Hide">AAC</span>
			</td>
	...
	<table>
		<tr>
			...
			<td class="VideoColumn1 LabelAlign PackageModeItem">
				<span class="TaskLabelText"><s:text name="audio.packageMode"/>:</span>
			</td>
			<td class="LabelEndSpacing PackageModeItem"><div class="LinePlaceHolder"></div></td>
			<td class="VideoColumn2 PackageModeItem">
				<select name="AudioPackageMode" class="SummaryTrigger TaskContentText AudioSelect">
					<option value="<s:property value="[0].audioSetting.packageMode"/>" selected="selected"></option>
				</select>				
			</td>
			<td><div class="LinePlaceHolder"></div></td>
		</tr>
