...
<div class="LogoItem <s:if test='[0].sourceType == 1'>Hide</s:if>">
	<input type="hidden" name="LogoSourceType" value="<s:property value="[0].sourceType"/>"/>
	<!-- Line1 -->
		...
		<tr>
			...
			<td class="VideoColumn2">
				<input type="text" name="LogoResize" class="TaskContentText VideoText"
					value="<s:property value="[0].resize"/>"/>
				<span class="TaskContentText">%</span>
			</td>
			<td><div class="LinePlaceHolder"></div></td>
		</tr>
