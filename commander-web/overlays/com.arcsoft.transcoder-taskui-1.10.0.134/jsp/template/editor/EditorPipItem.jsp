	...
	<table >
		<tr>
			...
			<td class="PipColumn3">
				...
				<input type="hidden" name="PipProgramIdDown" value="<s:property value="[0].programId"/>"/>
			</td>
			<td class="PipColumn2 LabelAlign">
			...
			<td class="PipColumn3">
				...
				<input type="hidden" name="PipAudioTrackIdDown" value="<s:property value="[0].audioTrackId"/>"/>
			</td>
			<td class="PipColumn2 LabelAlign">
			...
			<td class="PipColumn3">
				...
				<input type="hidden" name="PipSubtitleIdDown" value="<s:property value="[0].subtitleId"/>"/>
			</td>
			<td><div class="LinePlaceHolder"></div></td>
		</tr>
	</table>
		...
		<tr>
			...
			<td class="PipColumn3">
				<input type="text" name="PipAlpha" class="TaskContentText VideoText"
					value="<s:property value="[0].alpha"/>"/>
		...
		<tr>
			...
			<td class="PipColumn3">
				<input type="text" name="PipInsertTime" class="TaskContentText VideoText"
					value="<s:property value="[0].insertTime"/>"/>
			</td>
			<td><div class="LinePlaceHolder"></div></td>
		</tr>
	</table>
