...
<div id="SdiJoinedItemTmpl" class="JoinedItem alternate_uri_item">
	...
	<table class="JoinedProgramLine">
		<tr>
			...
			<td class="ProgramColumn2">
				...
				<input type="hidden" name="JoinedProgramIdDown" value=""/>
			</td>
			...
			<td class="ProgramColumn2">
				...
				<input type="hidden" name="JoinedAudioTrackIdDown" value=""/>
			</td>
			<td class="ProgramColumn1 LabelAlign">
			...
			<td class="ProgramColumn2">
				...
				<input type="hidden" name="JoinedSubtitleIdDown" value=""/>
			</td>
			<td><div class="LinePlaceHolder"></div></td>
		</tr>
	</table>
