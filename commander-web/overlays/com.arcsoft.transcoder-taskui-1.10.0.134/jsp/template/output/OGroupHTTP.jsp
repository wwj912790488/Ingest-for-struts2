	...
	<div class="OutputGroupContent">
			...
			<tr>
				...
				<td class="">
					<input type="hidden" name="OutputGroupPathURI"
						value="<s:property value="[0].outputGroupSetting.pathUri" />"/>
					<input type="text" name="OutputGroupCustomURI" class="TaskContentText OutputURIInput"
						value="<s:property value="[0].outputGroupSetting.customUri" />"/>
				</td>
				<td><div class="LinePlaceHolder"></div></td>
			</tr>
		</table>
		...
		<table>
			<tr>
				...
				<td class="LabelEndSpacing"><div class="LinePlaceHolder"></div></td>
				<td class="">
					<span class="OutputGroupUriDisp TaskUriLabel"></span>
				</td>
				<td><div class="LinePlaceHolder"></div></td>
			</tr>
		</table>
